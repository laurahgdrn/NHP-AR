...
# Paths
config_path = "C:/Users/hagedorn/mmaction2/work_dirs/stgcn_8xb16-joint-u100-80e_ntu60-xsub-keypoint-3d/stgcn_8xb16-joint-u100-80e_ntu60-xsub-keypoint-3d.py"
checkpoint_path = "C:/Users/hagedorn/mmaction2/work_dirs/stgcn_8xb16-joint-u100-80e_ntu60-xsub-keypoint-3d/best_acc_top1_epoch_20.pth"
...
output_video_path = "3d-st-gcn_prediction.mp4"  # Path to save the output video

with open("C:/Users/hagedorn/Desktop/data/macaques_skeleton_3d.pkl","rb") as f: 
    data = pickle.load(f)
...
pose_results = []
for frame_keypoints in ann['keypoint']:

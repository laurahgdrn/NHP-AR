...
with open("macaques_skeleton_3d.pkl", "rb") as f: 
    drei = pickle.load(f)


output_data = {
    "split": {
        "x_train": [],  # Assuming all frames are part of the training split
        "x_val": []     # Assuming all frames are part of the validation split
    },
    "annotations": []
}
...
#                 keypoint_score = np.ones((2, 17))  # Assuming 25 keypoints per person
